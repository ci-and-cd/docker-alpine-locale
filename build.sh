...
export IMAGE_NAME=${IMAGE_NAME:-alpine-locale}
export IMAGE_TAG=${IMAGE_ARG_LOCALE:-en_US}.${IMAGE_ARG_ENCODING:-UTF-8}_${IMAGE_ARG_TZ_AREA:-Etc}.${IMAGE_ARG_TZ_ZONE:-UTC}-alpine-3.7
